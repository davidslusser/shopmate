...
# import serializers
from storemgr.serializers import (CustomerSerializer,
                                  OrderSerializer,
...
# import filtersets
from storemgr.filtersets import (CustomerFilterSet,
                                 OrderFilterSet,
...
class OrderViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        queryset = self.model.objects.all().select_related('customer', 'status', )
